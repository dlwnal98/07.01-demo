...
🎯 후속 조치: 없음`,
        ...
        consultationType: [
          ...
          { id: 3, type: "날씨상담 > 기타", description: "기타 날씨 관련 문의", selected: false },
          { id: 4, type: "불만접수 > 진료시간 > 운영 시간 문의", description: "운영시간 관련 불만", selected: false },
        ],
      }
    ...
    return (
      <div className="space-y-1">
        ...
        {consultationTypes.map((item) => (
          <div key={item.id} className="grid grid-cols-12 gap-2 py-2 hover:bg-slate-50 rounded">
            <div className="col-span-1 text-center text-sm">{item.id}</div>
            <div className="col-span-11">
