      ...
      const mockResponses = {
        ...
        knowledge: [
          ...
          },
          {
            title: "우천 시 대안 활동",
            content:
              "비가 올 때는 실내 활동을 추천하고, 우산이나 우비 준비를 안내해주세요.",
            category: "날씨 대응",
          },
        ],
        summary: `📋 상담 요약
...
🎯 후속 조치: 없음`,
  ...
  const renderConsultationTypeSection = () => {
    ...
    const consultationTypes = sections.consultationType
      .content as ConsultationType[];
    return (
      <div className="space-y-1">
        ...
        {consultationTypes.map((item) => (
          <div
            key={item.id}
            className="grid grid-cols-12 gap-2 py-2 bg-slate-100 rounded hover:cursor-pointer"
          >
  ...
  const chatData = sections.chat.content as ChatData;
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-4">
            <Card className="h-full flex flex-col shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="flex-1 flex flex-col p-0">
                ...
                <ScrollArea className="flex-1 px-4  max-h-[calc(100vh-200px)] overflow-y-scroll">
          ...
          <div className="col-span-12 lg:col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                <h2 className="text-lg font-semibold text-slate-900">
                  {sections.consultationType.title}
                </h2>
                <Button
                  size="sm"
                  variant="ghost"
